...
def json_result(func: Callable):
    result = {}
    if os.path.exists('reshenie.json'):
        with open('reshenie.json', 'r', encoding='UTF-8') as file:
            result = json.load(file)
    else:
        with open('reshenie.json', 'w', encoding='UTF-8') as file:
    ...
    def wrapper(*args):
        ...
        return roots
    print("Решение квадратных уравнений  добавлено в файл reshenie.json")
    return wrapper
